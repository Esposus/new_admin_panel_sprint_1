# Generated by Django 4.2.11 on 2024-03-24 17:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('movie', 'Фильм'), ('tv_show', 'ТВ-шоу')], max_length=255, verbose_name='type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.TextField(choices=[('director', 'Режиссёр'), ('actor', 'Актёр'), ('writer', 'Сценарист')], verbose_name='role')),
                ('created', models.DateTimeField(auto_now_add=True)),
